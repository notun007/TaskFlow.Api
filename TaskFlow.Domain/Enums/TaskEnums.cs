...
public enum TaskStatus { Draft, Submitted, Triaged, Approved, Assigned, InProgress, PendingInformation, PendingVendor, ReadyForTesting, Testing, Uat, Resolved, Closed, Rejected, Cancelled, Reopened }
